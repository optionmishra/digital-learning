<div class="d-flex">
    <button class="btn btn-link nav-link d-flex align-items-center edit-btn px-2 py-2" type="button" title="Edit"
        ...
        data-row-data="{{ json_encode(['id' => $topic->id, 'name' => $topic->name, 'standard_id' => $topic->book->standard_id, 'subject_id' => $topic->subject_id, 'book_id' => $topic->book_id, 'serial' => $topic->serial]) }}">
